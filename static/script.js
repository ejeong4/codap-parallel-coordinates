...
document.getElementById("upload-form").addEventListener("submit", function(event) {
    ...
    .then(data => {
        ...
        renderCurrentClusters();  // Initial K-Means chart rendering
        renderParallelCoordinates();  // Parallel coordinates chart render
    });
});
...
function renderParallelCoordinates() {
    // Call the function to render parallel coordinates with the same data used for clusters
    drawParallelCoordinates(currentClusters.flatMap(cluster => cluster.points));
}
